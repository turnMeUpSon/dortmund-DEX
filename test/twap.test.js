...
describe("DortmundV3Twap", () => {
    it("get price", async () => {
        const DortmundV3Twap = await ethers.getContractFactory("DortmundV3Twap")
        const twap = await DortmundV3Twap.deploy(FACTORY, TOKEN_0, TOKEN_1, FEE)
        await twap.deployed()

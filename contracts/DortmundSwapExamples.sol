...
contract DortmundSwapExamples {
    ...
    function swapExactInputSingle(
        ...
        ISwapRouter.ExactInputSingleParams memory params = ISwapRouter
            .ExactInputSingleParams({
                ...
                // for the price the swap will push the pool to, which can help protect against price impact
                sqrtPriceLimitX96: 0
            });
    ...
    /// @notice swapExactOutputMultihop swaps a minimum possible amount of WETH for a fixed amount of USDT
    /// swap WETH --> USDT --> DAI
